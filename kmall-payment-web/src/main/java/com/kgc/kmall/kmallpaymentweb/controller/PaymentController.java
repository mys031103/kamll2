...
public class PaymentController {
    ...
    public String alipay(String outTradeNo, BigDecimal totalAmount, HttpServletRequest request, ModelMap modelMap) {
        ...
        paymentInfo.setCreateTime(new Date());//提交时间
        paymentInfo.setOrderId(omsOrder.getId().toString());//订单表orderID
        paymentInfo.setOrderSn(outTradeNo);//外部订单号
        paymentInfo.setPaymentStatus("未付款");
        paymentInfo.setSubject("沙箱环境测试支付");
        paymentInfo.setTotalAmount(totalAmount);//订单总金额
